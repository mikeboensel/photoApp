...
MIGRATION_MODULES = {
    'sites': 'struggla.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Michael Boensel""", 'michael-boensel@example.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
#INSTALLED_APPS += ['struggla.taskapp.celery.CeleryConfig']
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_EMAIL_VERIFICATION = 'none' # TODO restore to 'mandatory'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'struggla.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'struggla.users.adapters.SocialAccountAdapter'
